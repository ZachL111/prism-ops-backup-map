"""Regression checks for the prism-ops-backup-map casebook."""
...
from casebook.harness import assert_expected, prism_ops_backup_map_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(prism_ops_backup_map_summary(), assert_expected())
